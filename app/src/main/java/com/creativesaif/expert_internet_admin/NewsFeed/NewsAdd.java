...
public class NewsAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPost = findViewById(R.id.news_post_btn);
    ...
    public void news_add()
    {
        ...
        String url = getString(R.string.base_url)+getString(R.string.news_create);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hideDialog();
                Toast.makeText(NewsAdd.this,error.toString(),Toast.LENGTH_LONG).show();
            }
        }){
            @Override
            protected Map<String, String> getParams()throws AuthFailureError {
                ...
                String image = getStringImage(bitmapImage);
